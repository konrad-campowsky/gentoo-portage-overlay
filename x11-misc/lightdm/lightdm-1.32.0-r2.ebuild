...
IUSE="audit elogind +gnome gnome-keyring +gtk +introspection non-root qt5 systemd vala"
...
src_install() {
	...
	if use gnome-keyring; then
		newpamd "${FILESDIR}/${PN}-gk" "${PN}"
		newpamd "${FILESDIR}/${PN}-autologin-gk" "${PN}-autologin"
	else
